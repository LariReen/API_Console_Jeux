...
namespace API_Console_Jeux.Controllers
{
    ...
    public class JeuxConsolesController : ControllerBase
    {
        ...
        // GET: api/JeuxConsoles
        [HttpGet]
        public async Task<ActionResult<IEnumerable<JeuxConsole>>> GetJeuxConsole()
        {
            return await _context.JeuxConsole
                                 .Include(j => j.List_ventes) // Inclure les données de vente
                                 .ToListAsync();
        }
        ...
        {
            // Utilisez Include pour charger les données de vente associées au jeu de console spécifié par l'ID
